...
def build_output_payload(country_name, iso2, current_section, projection_section):
...
def main():
    ...
    payload = build_output_payload(country_name, iso2, current_section, projection_section)
